...
public:
  ...
  unsigned int Litui(const string&);
  ...
  float Litmag(const string &);
  float Litang(const string &);
  void Ecritmag(const string &, float f);
  void Ecritang(const string &, float f);
